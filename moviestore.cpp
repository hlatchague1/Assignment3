...
bool MovieStore::AddToMovies(string fileName)
{
	return false;
}

bool MovieStore::AddToCustomer(string fileName)
{
	return false;
}

bool MovieStore::AddToCommands(string fileName)
{
	return false;
}
